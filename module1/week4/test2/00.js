...
console.log(tempConverter(32, true)); //returns 89.6 as a result
console.log(tempConverter(32, false)); //returns 0.0 as a result
console.log(tempConverter(98.6, false)); //returns 37 as a result
console.log(tempConverter("12", false)); //returns NaN as a result
